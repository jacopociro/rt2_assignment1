...
Description\+: ~\newline
 This node is the center of the system architercture, calling the user\+\_\+interface, the position and the action clients. It implements a server for /user\+\_\+interface, handling the user input and acts with it. In case the user asks for random behaviour it starts it and waits for a stop or different command. 
