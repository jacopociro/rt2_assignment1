...
\begin{DoxyCompactList}\small\item\em \+: Callback for when the server is called \end{DoxyCompactList}\item 
...
\+: 0
\end{DoxyReturn}
This function initializes the ros node and the server /position\+\_\+server. Then lays in wait for a request. \mbox{\Hypertarget{position__service_8cpp_ab65b9ff5368189ad34fe4989d50742e4}\label{position__service_8cpp_ab65b9ff5368189ad34fe4989d50742e4}} 
...
\+: Callback for when the server is called 


\begin{DoxyParams}{Parameters}
{\em req} & Random\+Position Request \\
\hline
{\em res} & Random\+Position Response\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\+: True
\end{DoxyReturn}
This function calls the random number generator 3 times, on for the x position, one for the y position and one for the theta orientation between each fixed interval. \mbox{\Hypertarget{position__service_8cpp_a10f83119b77a8fbd085a5550955f85ff}\label{position__service_8cpp_a10f83119b77a8fbd085a5550955f85ff}} 
